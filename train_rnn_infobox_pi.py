...
CWD = os.getcwd()
SAVE_MODEL_PATH = os.path.join(CWD, "net_params", "rnn_infobox_pi", "net_rnn_infobox_pi_epoch%d.params")
WORD_DIMENSION = 100
...
input_train = np.load('data_train_rnn_infobox_pi.npy')
input_test = np.load('data_test_rnn_infobox_pi.npy')
...
def evaluate_model(net, epoch):
    ...
    np.save("Custom-net_rnn_infobox_pi_epoch.npy", result.asnumpy())
