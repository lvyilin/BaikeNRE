...
MARK = "rnn_G"
CWD = os.getcwd()
SAVE_MODEL_PATH = os.path.join(CWD, "net_params", "lstm", "net_{}_epoch%d.params".format(MARK))
...
class Network(nn.Block):
    ...
    def forward(self, input_data):
        h = self.lstm(input_data.reshape((input_data.shape[0], FIXED_WORD_LENGTH, DIMENSION)))
