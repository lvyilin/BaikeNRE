...
CWD = os.getcwd()
SAVE_MODEL_PATH = os.path.join(CWD, "net_params", "rnn_pi_p", "net_rnn_pi_p_epoch%d_12610.params")
...
input_train = np.load('data_train_rnn_pi_p.npy')
input_test = np.load('data_test_rnn_pi_p.npy')
