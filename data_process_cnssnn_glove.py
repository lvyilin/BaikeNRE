...
CWD = os.getcwd()
WORDVEC = CWD + "\\glove\\word2vec.txt"
...
entityvec_key = []
entityvec_value = np.load('entity2vec_value_glove.npy')
...
wordvec = KeyedVectors.load_word2vec_format(WORDVEC)
...
np.save('data_train_cnssnn_glove.npy', filter_train)
np.save('data_test_cnssnn_glove.npy', filter_test)
